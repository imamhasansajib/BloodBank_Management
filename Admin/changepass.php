...
<body>
    ...
    <div class="container">
        <div>&nbsp</div>
        <h1 class="row">Change Password of admin</h1></br>
        <form action="changepass.php" method="post">
            ...
            <?php if (isset($_POST['submit'])) {
                ...
                $repass = $_POST['repass'];
                if ($newpass == $repass) {
                    $sql = "select pass from admin where pass='$oldpass' and email='$email'";
                    $r = mysqli_query($con, $sql);
                    if (mysqli_num_rows($r) > 0) {
                        $sqli = "update admin set pass='$newpass' where email='$email'";
