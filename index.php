...
<body>
    ...
    <div class="container">
        <h1 class="my-4">
            <center><b>Welcome to Blood Bank & Donor Management System</b></center>
        </h1>
    </div>
    <div>&nbsp</div>
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <p style="text-align: justify; text-justify: inter-word;">
                    ...
                    potential blood donors, the Organizers and ICM Computers do not
    ...
    <footer class="footer mt-auto py-4 bg-dark">
        <div class="container">
            <span class="text-muted">
                <center>Copyright &copy; Blood Bank & Donor Management System 2022</center>
            </span>
        </div>
    </footer>
